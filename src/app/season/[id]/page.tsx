...
export default async function SeasonPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="container flex flex-col items-center gap-8 px-4 py-6 md:px-16 md:py-12" style={{ minHeight: '100vh' }}>
      <header className="flex flex-col items-center gap-4" style={{ textAlign: 'center', marginBottom: '2rem', width: '100%' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '2rem', width: '100%' }}>
          ...
          <h1 className="neon-text" style={{ fontSize: 'clamp(2rem, 8vw, 3.5rem)', letterSpacing: '2px', textTransform: 'uppercase', margin: 0, flex: 1, maxWidth: '100%', wordBreak: 'break-word', lineHeight: '1.1' }}>
